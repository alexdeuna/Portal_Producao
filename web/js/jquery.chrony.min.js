...
(function($) {
    var methods = {init: function(options) {
            return this.each(function() {
                ...
                var opt = self.opt, separator = '<span style="float: left;">:</span>';
                if (opt.text) {
                ...
                var hour = methods.getNumber(opt.hour), minute = methods.getNumber(opt.minute), second = methods.getNumber(opt.second), $hour = $("<div />", {id: "hour", html: hour, style: "float: left;"}), $minute = $("<div />", {id: "minute", html: minute, style: "float: left;"}), $second = $("<div />", {id: "second", html: second, style: "float: left;"}), timer = 0;
                if (opt.displayHours) {
                    $this.append($hour);
            ...
            var $this = $(this), alert = this.opt.alert;
    ...
    $.fn.chrony.defaults = {alert: {color: "#F00", hour: 0, minute: 0, second: 10}, blink: false, blinkTime: 130, finish: undefined, decrement: 1, displayHours: true, displayMinutes: true, displaySeconds: true, hour: 0, hours: undefined, minute: 0, minutes: undefined, second: 0, seconds: undefined, text: undefined};
})(jQuery);
